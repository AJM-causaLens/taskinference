...
# train_agent(("HalfCheetah-v5", "easy"), "varibad", 1, BBE=explore_bonus)
# train_agent(("HalfCheetah-v5", "hard"), "varibad", 2, BBE=explore_bonus)
# train_agent(("point_mass", "easy"), "varibad", 2, BBE=explore_bonus)
# train_agent(("point_mass", "hard"), "varibad", 2, BBE=explore_bonus)
train_agent(("Swimmer-v5", "easy"), "varibad", 1, BBE=explore_bonus)
