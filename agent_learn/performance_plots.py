...
env_labels = {"point_mass_easy": "Point Mass Easy", "point_mass_hard": "Point Mass Hard",
              "HalfCheetahVel_easy": "HalfCheetah Easy", "HalfCheetahVel_hard": "HalfCheetahVel (Sparse)",
              "Swimmer_easy": "Swimmer-v5"}
agent_labels = {"naive": "Naive", "oracle": "Oracle", "belief": "Belief Net",
                "tibbe": "Tibbe", "moss": "MoSS", "varibad": "VariBAD", "varibad_local": "VariBAD",
                "tibbe_alpha": "Tibbe Alpha",
                "tibbe_beta": "Tibbe Beta", "ti": "TaskInf"}
confidence_interval = 0.2

# exclude = ["oracle", "tibbe_alpha", "tibbe_beta", "tibbe_BBE", "tibbe_alpha_BBE", "tibbe_beta_BBE", "tibbe"]
# exclude = ["oracle", "tibbe_alpha", "tibbe_beta", "tibbe_BBE", "tibbe_alpha_BBE", "tibbe_beta_BBE", "tibbe", "naive", "belief", "varibad"]
exclude = ["oracle", "varibad_local", "naive", "ti_BBE"]
# exclude = ["oracle", "naive", "ti_BBE"]
...
def plot_performance(exclude: list[str] = None, env_name: str = "point_mass_easy"):
    ...
    # config_dir = f"bbe_agents/{env_name}"
    ...
    for metric in metrics:
        ...
        plt.savefig(f"{env_labels[env_name]}_{metric_labels[metric]}.png", bbox_inches='tight')
...
plot_performance(env_name ="Swimmer_easy", exclude=["oracle", "naive", "ti_BBE"])
