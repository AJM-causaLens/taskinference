...
class TaskDistribution(gym.Wrapper):
    """
...
class PointmassDistribution(TaskDistribution):
    """
...
class CheetahRunDistribution0(TaskDistribution):
    def __init__(self, env, vae, tasks):
        super().__init__(env, vae, tasks)
...
class CheetahRunDistribution1(TaskDistribution):
    def __init__(self, env, vae, tasks):
        super().__init__(env, vae, tasks)
...
class CheetahRunDistribution2(TaskDistribution):
    def __init__(self, env, vae, tasks):
        super().__init__(env, vae, tasks)
...
class SwimmerDistribution(TaskDistribution):
    def __init__(self, env, vae, tasks):
        super().__init__(env, vae, tasks)
    ...
    def get_reward(self, reward, obs, info):
        ...
        # get different between the tip velocity and the goal velocity
        reward = 1 if np.abs(tip_velocity - self.current_env_params) < 0.02 else 0
        return reward
class ReacherDistribution(TaskDistribution):
    """
